...
return [
    ...
    'activity_empty_hint'         => 'Activity history appears here when the server provides it.',
    ...
    'kanban_due_filter_scope_note'=> 'Kanban shows tasks from the current result page only. Position reordering is not available until the API accepts a position field.',
    'kanban_add_task'             => 'Add',
